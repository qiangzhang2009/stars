export default {
    ...
    subscribeSloganTittle: 'Subscribe to "AI Fortune" to Explore the Wisdom of Cross-Era Convergence!',
    ...
    ContinueOnStarloom: 'Continue chatting on AI Fortune',
    collapse: 'Collapse',
    expand: 'Expand',
    ...
    shareSlogan: 'You may not know your fate, but maybe AI does！Come to AI Fortune for a free experience.',
    jxrg: 'Enneagram',
    ...
    listening: 'Listening',
    waitingReply: 'Waiting for reply from AI Fortune',
